...
* **Linear Algebra**
   * 1: [Intro to Linear Algebra](https://github.com/rahiakela/mathematics-for-machine-learning/blob/main/machine-learning-foundations/linear-algebra/1-intro-to-linear-algebra.ipynb)
   * 2: [Linear Algebra II: Matrix Operations](https://github.com/rahiakela/mathematics-for-machine-learning/blob/main/machine-learning-foundations/linear-algebra/2-linear-algebra-ii.ipynb)
* **Calculus**
