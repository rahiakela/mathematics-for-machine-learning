...
1. [Scalars, Vectors, Matrices and Tensors](https://github.com/rahiakela/deep-learning-book-maths/blob/main/2_1_scalars_vectors_matrices_and_tensors.ipynb)
...
2. [Multiplying Matrices and Vectors](https://github.com/rahiakela/deep-learning-book-maths/blob/main/2_2_multiplying_matrices_and_vectors.ipynb)

    <img src="images/dot-product.png" width="400" alt="An example of how to calculate the dot product" title="The dot product explained">
...
3. [Identity and Inverse Matrices](https://github.com/rahiakela/deep-learning-book-maths/blob/main/2.3-identity-and-inverse-matrices.ipynb)

    <img src="images/identity-matrix.png" width="200" alt="Example of an identity matrix" title="An identity matrix">
...
4. [Linear Dependence and Span](https://github.com/rahiakela/deep-learning-book-maths/blob/main/2_4_linear_dependence_and_span.ipynb)
